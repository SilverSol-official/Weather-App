    ...
    return (
        <div className={`header ${themeAdditionBg}`}>
            ...
            <div className={`wrapper ${themeAdditionBg}`}>
                <div className="theme">
                    <Button variant={darkTheme? 'dark':'light'} onClick={()=>dispatch(changeTheme())}>
                ...
                <InputGroup className={`mb-3 ${themeAdditionBg}`}>
                    ...
                    />
                    <Link to={`/${cityInput}`}>
                        <Button variant="outline-secondary" id="button-addon2" onClick={()=>dispatch(fetchWeather(cityInput))}>
                            <SearchIcon/>
                        </Button>
                    </Link>
